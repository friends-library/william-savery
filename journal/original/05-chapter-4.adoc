...
wishing one another`'s welfare here and for ever.
...
you will have an audience with the King to-morrow morning at nine o`'clock.
...
if some times you will make me joyful by imparting a few lines of love,
...
acknowledge all o«r doctrines, and we hope are honestly seeking a right foundation.
...
and the country being every where crowded with Prussian soldiers,
...
after weighing it,
we concluded to put off the appointment of another meeting until to-morrow.
...
Travellers become more numerous as we approach Amsterdam: we were taken for Hanoverian«,
...
In almost every thing they are the reverse of Germany; the furniture, etc.,
...
we requested it might be cleared out and made ready for meeting to-morrow.
...
were glad to rise and proceed on o«r journey.

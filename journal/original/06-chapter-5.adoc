...
and said there were a number of religious men in that regiment,
...
then taking post-chaise, we passed through the town of Kircaldy and several lesser towns,
...
who had read some parts of Barclay`'s [.book-title]#Apology,#

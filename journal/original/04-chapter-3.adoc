...
and pleased with the hope of seeing Liverpool to-morrow evening.
...
The streets are narrow, have few foot-ways, and being every where paved with pebbles,
...
We parted lovingly, both the pastor and his wife pressing me to come to-morrow.
...
said he read every thing, and was visited by kings and princes,
...
The people every where in Prussia are astonished when we tell them we are from America,
...
which at first they did not seem disposed to, intending to lock them up until to-morrow.
...
Albinus took up his lodgings with us at the inn where we staid
